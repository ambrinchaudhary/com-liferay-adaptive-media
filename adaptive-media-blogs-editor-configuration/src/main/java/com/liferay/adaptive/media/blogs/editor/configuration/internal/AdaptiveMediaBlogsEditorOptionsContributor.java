...
public class AdaptiveMediaBlogsEditorOptionsContributor
	...
	public void populateEditorOptions(
		...
		Class<?> adaptiveMediaImageReturnTypeClass =
			new ImageAdaptiveMediaURLItemSelectorReturnType().getClass();

		editorOptions.setUploadItemReturnType(
			adaptiveMediaImageReturnTypeClass.getName());
	}
