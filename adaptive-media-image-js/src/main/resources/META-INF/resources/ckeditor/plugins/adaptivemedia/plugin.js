(function() {
	var STR_ADAPTIVE_MEDIA_RETURN_TYPE = 'com.liferay.item.selector.criteria.AdaptiveMediaURLItemSelectorReturnType';
		...
		'adaptivemedia',
		{
			...
			_getPictureElement: function(selectedItem) {
				...
				try {
					...
					if (itemValue.defaultImage) {
						pictureHtml += '<img src="' + itemValue.defaultImage + '">';
					}
